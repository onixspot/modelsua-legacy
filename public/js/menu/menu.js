    ...
    buildmenu: function ($, setting) {
        ...
        $headers.hover(
            function (e) {
                ...
                $(this).find('img:eq(0)').attr('src', smoothmenu.arrowimages_selected.down[1]);

            },
            function (e) {
                $(this).children('a:eq(0)').removeClass('selected');
                $(this).find('img:eq(0)').attr('src', smoothmenu.arrowimages.down[1]);
            }
        )
        $headers.each(function (i) { //loop through each LI header
            ...
            //$subul.css({top:this.istopheader && setting.orientation!='v'? (this._dimensions.h)+"px" : '-1px'})
                ...
                function (e) {
                    ...
                    $targetul.data('timers').showtimer = setTimeout(function () {
                        ...
                        if ($targetul.queue().length <= 1) { //if 1 or less queued animations
                            $targetul.css({width: header._dimensions.subulw + 'px'}).animate({
                                height: 'show',
                                opacity: 'show'
                            ...
                            if (smoothmenu.shadow.enable && !smoothmenu.css3support) {
                                ...
                                header.$shadow.removeClass('hide').css({
                                    overflow: '',
                ...
                function (e) {
                    ...
                    $targetul.data('timers').hidetimer = setTimeout(function () {
                        ...
                        if (smoothmenu.shadow.enable && !smoothmenu.css3support) {
                            ...
                            header.$shadow.css({overflow: 'hidden'}).addClass('hide').animate({height: 0}, ddsmoothmenu.transition.outtime)
                        }

<div class="fs10 px-3 pt-2 pb-1">
    <div class="left" style="width: 262px;">
        <a href="/">
            <img src="/<?= session::get('language', 'ru') ?>/logo_l1.png"/>
            <img src="/<?= session::get('language', 'ru') ?>/logo_l2.png"/>
        </a>
    </div>
    ...
    <div class="right" style="width: 172px">
        <div class="languages_box bold aright fs11">

...
class PHPMailer {
  ...
  public function CreateHeader() {
    ...
    if($this->Mailer != 'mail') {
      /*$to=$this->to;
      if (substr($to[0][0],-9)=='gmail.com') */$result .= $this->HeaderLine('Subject', /*$this->EncodeHeader($this->SecureHeader(*/"=?utf-8?B?".base64_encode($this->Subject)."?="/*))*/);
      //else $result .= $this->HeaderLine('Subject', $this->EncodeHeader(/*$this->SecureHeader(*/$this->Subject/*))*/));
    }

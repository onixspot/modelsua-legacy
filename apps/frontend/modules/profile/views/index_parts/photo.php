<div class="fs12 acenter">
	...
	<div class="pt15 pb15" style="background: #eee; border: 1px solid #ccc">
		...
		<?if(voting_peer::can_vote($profile['user_id'], voting_peer::MODEL_RATING) && 0) {?>
			<center>
				<div class="pointer mt15" style="background: #B95383; width: 200px; color: white;"  onClick="App.vote('<?=$profile["user_id"]?>','<?=voting_peer::MODEL_RATING?>',1,'model_rating_votes'); $('#rating_hand').removeAttr('onClick').removeClass('pointer'); $(this).remove();">

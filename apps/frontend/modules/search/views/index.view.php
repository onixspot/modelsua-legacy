...
<div class="search_form_box" style="">
    <div class="left pt10 pb5 pl10" style="width: 100%;">
        ...
        <div class="mr20 right">
                ...
                <?if($users) {?><a href="javascript:;" onClick="$('#search_form, .showhidelink').toggleClass('hide');" class="cpurple showhidelink <?=($users) ? ' hide' : ''?>"><?=t('Свернуть форму')?></a><? } ?>
    ...
    <form id="search_form" class="<?=($users) ? 'hide' : ''?>">
	    ...
	    <tr>
                ...
                <td>
                    <select id="status_filter" multiple="multiple" name="status_filter[]" style="width: 350px; float: left;">
					<?
...
//						echo '<option value="0" selected>&mdash;</option></optiongroup>';
					...
					?>
					<?
						function build_url($ex=array()) {
							$ex = array_diff(array('q','status','filter','active','hidden'),$ex);
...
<!--            <tr>
	    ...
	    <tr>
            ...
            <tr>
                ...
                <td>
                    <?=tag_helper::select('eye_color[]', $params['eye_color'], array('value'=>  request::get_int('eye_color'), ' multiple'=>"multiple"));?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <?=tag_helper::select('hair_color[]', $params['hair_color'], array('value'=>  request::get_int('hair_color'), ' multiple'=>"multiple"));?>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <?=tag_helper::select('hair_length[]', $params['hair_length'], array('value'=>  request::get_int('hair_length'), ' multiple'=>"multiple"));?>
                </td>
            </tr>
            <tr>
                <td colspan="2">
	    ...
	    <tr rel="atype1">
                ...
                <td>
                    <?
                        ...
                        $alist[-1] = 'Другое';
                    ?>
                    <?=tag_helper::select('agency', $alist,array('id'=>'agency'), array('value'=>  request::get_int('agency')));?>
...
<!--            <tr>
	    ...
	    <tr rel="atype0">
            ...
            <tr>
                ...
                <td>
                    <?=tag_helper::select('work_experience', $slist['work_experience'], array('value'=>  request::get_int('work_experience')))?>
                </td>
            </tr>
            <tr>
                <td>
...
$(document).ready(function(){
	...
	$('select[id="status_filter"]').change(function(){
		...
		if(!$('#independent_model_row').hasClass('hide'))

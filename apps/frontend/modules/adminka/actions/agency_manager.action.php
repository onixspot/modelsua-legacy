...
class adminka_agency_manager_action extends adminka_controller
{
	...
	public function execute()
	{
		...
		if(in_array($this->adminka["act"], array("add", "edit_json", "publicate", "remove", "remove_selected", 'create_page')))
		{
			...
			$this->list = agency_peer::instance()->get_list(array(), array(), array("id ASC"));
	}
